...
namespace QLBH_BHX.UI.MainMenu.Sales_Management
{
    public partial class ThemDVT : Form
    {
        ...
        private void btAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                string maDVT = txtMa.Text.Trim();
                string tenDVT = txtTen.Text.Trim();
                ...
                {
                    MessageBox.Show("Vui lòng nhập Tên đơn vị tính của sản phẩm.", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    txtTen.Focus();
                    return;
                }
                ...
                try
                {
                    ...
                    int affectedRows = dal.ThemLoaiSanPham(maDVT, tenDVT);
